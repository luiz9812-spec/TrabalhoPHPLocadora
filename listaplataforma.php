...
<head>
    ...
    <title>Game Rent - Lista de Plataformas</title>
...
<body>
    ...
    <main>
        ...
        <section class="ultimos-cadastros">
            ...
            <a class="card-link" href="listajogos.php?idplataforma=<?= $jogo['ID_PLATAFORMA'] ?>">    
                <div class="card">
                    <img class="img-plataforma" src="./img/plataforma/<?= preg_replace('/[^a-zA-Z0-9_-]/', '_', $jogo['NOME']) ?>.png" alt="Lista de jogo para <?= $jogo["NOME"] ?>">
                    <h2><?= $jogo["NOME"] ?></h2>
                </div>
            </a>
            <?php } ?>
