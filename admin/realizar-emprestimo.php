...
<head>
    ...
    <title>Game Rent - Realizar Emprestimo</title>
    ...
    <main>
        <article class="introducao">
            <ul class="breadcrumb">
                ...
                <li>Realizar Emprestimo</li>
            </ul>
        </article>
        <h1 class="titulo">Realizar Emprestimo</h1>
        <section class="tela-cadastro-cliente">
            <form action="emprestimo.php" id="form-cadastro" enctype="multipart/form-data" method="POST">
                <div>
                    <label for="cpf">CPF do cliente: </label>
                    <input type="text" name="cpf" id="cpf" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}$" required maxlength="14">
                </div>
                <div>
                    <label for="jogo">ID do Jogo: </label>
                    <input type="number" name="idjogo" id="idjogo" required>
                </div>
                <div>
                    <button>Realizar Emprestimo</button>
                </div>
            </form>
        </section>
    </main>
