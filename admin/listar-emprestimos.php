<?php 
    ...
    INNER JOIN CLIENTES C ON C.CPF = E.CPF;"; // String com o comando SQL SELECT
...
<body>
    ...
    <main>
        ...
        <table border="1">
            <tr>
                <th>AÇÕES</th>
                <th>ID</th><th>JOGO</th><th>CPF</th><th>CLIENTE</th><th>DATA DO EMPRESTIMO</th><th>DATA DE ENTREGA</th><th>STATUS DE DEVOLUÇÃO</th>
            </tr>
