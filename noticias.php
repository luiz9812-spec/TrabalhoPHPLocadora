...
<head>
    ...
    <title>Game Rent - Lista de Notícias</title>
    ...
    <main>
        <article class="introducao">
            <ul class="breadcrumb">
                ...
                <li>Lista de Notícias</li>
            </ul>
        </article>
        <h1 class="titulo">Notícias</h1>
        <section class="listas-noticias">
            <?php foreach($resultado as $noticia) { ?>
            <a class="card-link" href="noticia.php?idnoticia=<?= $noticia['ID_NOTICIA'] ?>">
                <div class="card">
                    <img class="img-plataforma" src="./img/noticias/<?= $noticia["ID_NOTICIA"] ?>.png" alt="Lista de jogo para <?= $noticia["TITULO"] ?>">
